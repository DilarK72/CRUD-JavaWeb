...
<form type="hidden "name="action" method="saveMember">
    <input type="hidden" name="action" value="saveMember">
    <input type="hidden" name="db_operation" value="update"> 
    
    <label>Email:</label>
    <input type="email" name="emailAddress" value="${member.emailAddress}" readonly><br><br>
       <label>Full Name:</label>
    <input type="text" name="fullName" value="${member.fullName}" ><br><br>
    <label>Phone:</label>
    <input type="phone" name="phoneNumber" value="${member.phoneNumber}" ><br><br>
